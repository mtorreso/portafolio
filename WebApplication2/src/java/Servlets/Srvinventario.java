...
public class Srvinventario extends HttpServlet {
    ...
    InventarioService reser = new InventarioService();
    String add = "nuevoinventario.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion.equals("add")) {
            ...
            String iddepto = request.getParameter("txtiddepartamento");
            String producto = request.getParameter("txtproducto");
            String cantidad = request.getParameter("txtcantidad");
            String estado = request.getParameter("txtestado");
            String descripcion=request.getParameter("txtdescripcion");
            reser.nuevoinventario(iddepto, producto, cantidad, estado, descripcion);
            acceso = index;
