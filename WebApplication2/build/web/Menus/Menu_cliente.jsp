<%-- 
    ...
    Created on : 22-04-2015, 15:43:22
    Author     : melipilla
--%>
            ...
            <div class="container d-flex align-items-center px-4">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a href="Cliente.jsp" class="nav-link pl-0">Home</a></li>
                        <li class="nav-item"><a href="MisDatosClient.jsp" class="nav-link pl-0"><span class="glyphicon glyphicon-user"></span>Mis Datos</a></li>
                        <li class="nav-item"><a href="departamentoscli.jsp" class="nav-link">Departamentos</a></li>                        
