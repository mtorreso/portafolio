            ...
            <div class="container d-flex align-items-center px-4">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a href="Funcionario.jsp" class="nav-link pl-0">Home</a></li>
                        <li class="nav-item"><a href="MisDatosOP.jsp" class="nav-link pl-0"><span class="glyphicon glyphicon-user"></span>Mis Datos</a></li>
                        <li class="nav-item"><a href="departamentos1.jsp" class="nav-link">Departamentos</a></li>
