    ...
    <body>
        <%
            if (request.getParameter("id") != null) {
                ...
                String respuesta = Consultas.eliminarUsuario(id);
                out.print("<br><br>");
                out.print("<div class='container text-center'>");
                out.print("<h2>Acción realizada" + "</h2><br><br>");
                out.print("<h2>" + respuesta + "</h2><br><br>");
                out.print("<a href='VerLista.jsp' class='btn btn-success' role='button'>Regresar</a>");
                out.print("</div>");
