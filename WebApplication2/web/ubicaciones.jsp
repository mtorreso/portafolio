                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown nav-item">
                            ...
                            <div class="container">
                                <a href="crearlocalidad.jsp" class="btn btn-info">Nuevo Localidad</a>
                                <br>
                                <br>
                                ...
                                <div class="panel panel-primary" style="background:#FFF;">
                                    ...
                                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="myTable">
                                            <%
                                                LocalidadService depto = new LocalidadService();
                                                List<Localidad> datos = depto.listarLocalidades();
                                                for (Localidad d : datos) {
                                            %>

                                            <tr>
                                                <td><%= d.getIdLocalidad()%></td>
                                                <td><%= d.getNombreLocalidad()%></td>
                                    ...
                                    src = "https://apis.modernizacion.cl/dpa/regiones?orderBy=lat&orderDir=desc
                                    " > 
                                    </script>
                                </div>
                            </div>
