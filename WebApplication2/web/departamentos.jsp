...
<html>
    <head>
        ...
        <link rel="stylesheet" href="estilos/perfilnavbar.css">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown nav-item">
                            ...
                            <div class="container">
                                ...
                                <a href="Crear_Material.jsp" class="btn btn-info">Nuevo Departamento</a>

                                <br>
                                <br>
                                <input class="form-control" id="myInput" type="text" placeholder="Buscar" value="">
                                <br>
                                    ...
                                    <table  class="table table-bordered responsive" id="dataTable">
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href='reservas.jsp'class='btn btn-default btn-xs' role='button'>Reservas <span class='glyphicon glyphicon-pencil'></span></a></td>
                                                <td>
                                                    <a href='Inventario_depto.jsp'class='btn btn-warning btn-xs' role='button'>Inventarios <span class='glyphicon glyphicon-pencil'></span></a>
                                                    <a href='Servdeptoadmin?accion=inventarios&id=<%= d.getId()%>'class='btn btn-info btn-xs' role='button'>Nuevo <span class='glyphicon glyphicon-pencil'></span></a></td>
                                                <td><a href='Modifica_depto.jsp?id=<%= d.getId()%>&fecha=<%= d.getFecha()%>&nombre=<%= d.getNombre()%>&ubicacion=<%= d.getUbicacion()%>  &banos=<%= d.getBanos()%>&habitaciones=<%= d.getHabitaciones()%>&valorarriendo=<%= d.getValorarriendo()%>&descripcion=<%= d.getDescripcion()%>' class='btn btn-success btn-xs' role='button'>Modificar <span class='glyphicon glyphicon-pencil'></span></a></td>
                                                <td><a href='Elimina_depto.jsp?id=<%= d.getId()%>' class='btn btn-danger btn-xs' role='button' onclick='return confirm(\'Seguro que desea Eliminar este usuario?\')'>Eliminar <span class='glyphicon glyphicon-trash'></span></a></td>
