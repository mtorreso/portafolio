    ...
    <div class="row">
        <div  id="scroll" class="col-12 col-sm-3">
            <div class="card bg-light mb-3">
                <div class="card-header btn btn-blue text-white text-uppercase"><i class="fa fa-list"></i>Localidades</div>

                <ul class="list-group category_block">
                    <%
                        LocalidadService localidad = new LocalidadService();
                        List<Localidad> dato = localidad.listarLocalidades();
                        for (Localidad l : dato) {
                    %>
                    <li class="list-group-item"><a href="categorias.jsp?<%=l.getNombreLocalidad()%>"><%=l.getNombreLocalidad()%></a></li>     
                     <%}%>
                </ul>
        ...
        <div class="col">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="./img/portadas.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><%=d.getNombre()%></h4>
                            <p class="card-text"><%=d.getUbicacion()%><BR>
                                <%=d.getHabitaciones()%> D / <%=d.getBanos()%> B
                            </p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">$<%=d.getValorarriendo()%></p>
                                </div>
                                <div class="col">
                                    <a  class="btn btn-blue" href="Servdepto?accion=editar&id=<%=d.getId()%>">Detalle</a>
                                </div>
                            </div>
                        </div>
                    </div>
